...
Time spent: 32-35 hours spent in total
...
* [ ] I created the profile and people can see all the tweets of that specific person in the profile
* [ ] also made the Login page more twitter friendly
* [ ] I made my own dividers for the UI and the UI of the followers list

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='./tweetdemo (1).mp4' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [Kap](https://getkap.co/).

## Notes

At first I had a lot of challenges when communicating with my API. I wasn't sure how the methods were
communicating, but slowly realized how to use the TwitterClient.java class.
